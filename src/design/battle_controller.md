...
> **_NOTE:_** Much of the information in this article was based on code from Deltarune Chapter 3.
...
> **_NOTE:_** We believe the hero markers actually move to the "heromake" arrays over a duration
